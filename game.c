...
int main() {
    ...
    player.texture.ship = loadTexture("assets/ship.png", ren);
    player.texture.flame = loadTexture("assets/flame.png", ren);
    player.ship.x = 0;
    player.ship.y = 32;
    player.ship.w = PLAYER_WIDTH;
    player.ship.h = PLAYER_HEIGHT;
    player.shipDest.x = player.location.x * pixel_size;
    player.shipDest.y = player.location.y * pixel_size;
    player.shipDest.w = PLAYER_WIDTH * pixel_size;
    player.shipDest.h = PLAYER_HEIGHT * pixel_size;
    player.flame.x = 0;
    player.flame.y = 0;
    player.flame.w = 16;
    player.flame.h = 16;
    player.flameDest.x = (player.location.x - 8) * pixel_size;
    player.flameDest.y = player.location.y * pixel_size;
    player.flameDest.w = PLAYER_WIDTH * pixel_size;
    player.flameDest.h = PLAYER_HEIGHT * pixel_size;
    ...
    while (running) {
            ...
            case SDL_KEYDOWN:
                ...
                case SDLK_f:
                    if (win_mode == 0) {
                        ...
                        pixel_size = 4;
                        player.shipDest.x *= pixel_size;
                        player.shipDest.y *= pixel_size;
                        player.shipDest.w *= pixel_size;
                        player.shipDest.h *= pixel_size;
        ...
        player.shipDest.y = ((int)player.location.y) * pixel_size;
        ...
        player.shipDest.x = ((int)player.location.x) * pixel_size;
        player.flameDest.x = ((int)player.location.x - 8) * pixel_size;

        // First clear the renderer
        SDL_SetRenderDrawColor(ren, 200, 200, 200, 255);
        SDL_RenderClear(ren);
        // Draw the textures
        SDL_RenderCopy(ren, player.texture.ship, &player.ship, &player.shipDest);
        SDL_RenderCopy(ren, player.texture.flame, &player.flame, &player.flameDest);
